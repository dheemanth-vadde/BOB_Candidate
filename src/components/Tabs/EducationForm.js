  ...
  return (
    <form className="row g-4 formfields" onSubmit={handleSubmit}>
      ...
      <div className="col-md-6 col-sm-12 mt-2">
        ...
        <textarea id="specialization" className="form-control" rows={4} value={formData.specialization} onChange={handleChange} />
      </div>
      ...
      <div className="d-flex justify-content-center mt-2">
        <button type="submit" className="btn blue-button mt-3">
          Submit
        </button>
      </div>
    </form>
